return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>ls", ":SessionManager load_session<CR><Esc>", {})
		vim.api.nvim_create_autocmd("VimEnter", {
			pattern = "*",
			callback = function()
				-- vim.cmd("SessionManager load_session")
				local keys = vim.api.nvim_replace_termcodes(":SessionManager load_session<CR><Esc>", true, false, true)
